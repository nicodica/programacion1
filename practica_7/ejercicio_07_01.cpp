...
int main () {
    ...
    int matriz[100][100];
    int aux=0; //Entero auxiliar para realizar el intermabio de valores en las filas
    ...
    // Cambiar la primera y ultima fila (o sea i)
    for (int i=0; i<n; i++) {
...
// Investiga como realizar funciones con matrices
